...
class FreshRSSConfigsTab extends React.Component<
    ServiceConfigsTabProps,
    FreshRSSConfigsTabState
> {
    constructor(props: ServiceConfigsTabProps) {
        super(props)
        const configs = props.configs as FreshRSSConfigs
        this.state = {
            existing: configs.type === SyncService.FreshRSS,
    ...
    save = async () => {
        ...
        configs = (await this.props.reauthenticate(configs)) as FreshRSSConfigs
            ...
            <>
                ...
                <Stack horizontalAlign="center" style={{ marginTop: 48 }}>
                    ...
                    <Stack className="login-form" horizontal>
                        ...
                        <Stack.Item grow>
                            <TextField
                                placeholder="https://your-freshrss.example/api/greader.php"
                                onGetErrorMessage={v =>
                                    urlTest(v.trim())
                                        ? ""
...
export default FreshRSSConfigsTab
